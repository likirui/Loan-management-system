...
Last name  <input type="text" name="lname" maxlength="20"><br><br>
Email      <input type="text" name='email' maxlength="35"><br><br>
Password   <input type="Password" name="password_1" maxlength="20"><br><br>
Confirm password <input type="password" name="password_2" maxlength="20"><br><br>
